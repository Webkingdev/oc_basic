...
<?php } ?>
<script src="catalog/view/theme/mystore/javascript/common.js" type="text/javascript"></script>
		...
		<div id="top-links" class="nav pull-right">
			<ul class="list-inline">
				...
				<li>
					...
					<a href="<?php echo $catalog; ?>">
						<span class="hidden-xs hidden-sm hidden-md">Каталог</span>
					</a>
				</li>
