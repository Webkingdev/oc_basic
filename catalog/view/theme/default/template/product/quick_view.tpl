				...
				<div class="<?php echo $class; ?>">
					<?php if ($thumb || $images) { ?>
						...
						<?php if ($thumb) { ?>
							<li>
								<div class="thumbnail">
									<img class="main_image_js" src="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" />
								</div>
							</li>
						<?php } ?>
						<?php if ($images) { ?>
							<?php foreach ($images as $image) { ?>
								<li class="image-additional">
									<div class="thumbnail">
										<img class="image_js" src="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" />
									</div>
								</li>
							<?php } ?>
						<?php } ?>
...
<script>
	$(function(){
		$('.image_js').on('click', function(){
			$('.main_image_js').attr('src', $(this).attr('src'));
		});
	});
</script>