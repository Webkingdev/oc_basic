...
function CDT(){
	// Set countdown limit / Установить время
	var tl = new Date('2016/11/28 00:00:00');
	// You can add time's up message here / Сообщение об окончании акции
