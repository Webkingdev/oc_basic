		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<?php if ($all_news) { ?>
					...
					<td class="text-right" style="text-align: center;"><a href="<?php echo $news['edit']; ?>" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="<?php echo $text_edit; ?>"><i class="fa fa-pencil"></i></a></td>
					</tr>
					<?php } ?>
				<?php } else { ?>
					<tr>
